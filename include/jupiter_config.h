...
// Define Onboard LED
#define ESP32_LED 2
#define STRING_LEN 20  // needed to receive strings in micro-ros when using std_msgs__msg__String led_msg
...
#define WHEEL_RADIUS 0.090
#define WHEEL_BASE_WIDTH 0.400
#define WHEEL_ENCODER_CPR 360.0

// PID and Control Loop parameters
#define PID_KP  0.5     //1.0
