...
void get_imu_data(sensor_msgs__msg__Imu* imu_msg, builtin_interfaces__msg__Time current_ros_time) {
    ...
    imu_msg->header.stamp.nanosec = current_ros_time.nanosec;
    imu_msg->header.stamp.sec = current_ros_time.sec;
